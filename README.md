...
*   **Trên Linux (Ubuntu/Debian)**:
    ...
    ```bash
    # 1. Cài đặt Python 3, venv, tkinter và các công cụ hệ thống
    sudo apt-get update
    sudo apt-get install python3 python3-pip python3-venv python3-tk python3-pil python3-pil.imagetk qrencode zbar-tools -y

    # 2. Tạo môi trường ảo (kết nối với thư viện hệ thống như tkinter)
